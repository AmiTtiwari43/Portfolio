...
export default function HeroOverlay() {
  return (
    <div className="relative z-50 flex flex-col items-center justify-center min-h-[90vh] text-center px-4 overflow-hidden pointer-events-auto">
      ...
      <div className="section-container relative">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="inline-block px-4 py-1.5 rounded-full border border-accent-tertiary/20 bg-accent-tertiary/5 text-accent-tertiary uppercase tracking-[0.4em] font-bold text-xl mb-4">
            AmiT Tiwari // Full_Stack_Engineer
          </div>
          
          <h1 className="text-5xl md:text-8xl font-black colorful-gradient-text tracking-tighter uppercase leading-[0.9]">
            Architecting <br /> 
            <span className="text-white">Scalable</span> Solutions
          </h1>
