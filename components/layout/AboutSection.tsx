  ...
  return (
    <section id="about" className="h-screen w-full relative flex items-center justify-center overflow-hidden bg-transparent antialiased">
      ...
      <motion.div 
        ...
        className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0 md:pl-24 pointer-events-auto"
      >
        <h1 className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          About Me
        </h1>
        <div className="mt-8 font-normal text-base text-neutral-300 max-w-2xl text-center mx-auto p-6 bg-transparent border border-white/10 rounded-2xl shadow-xl">
          <p className="mb-4">
